...
import { VainovskaKnot, Vainovska2Knot, Vainovska3Knot, Vainovska4Knot, Vainovska5Knot, SamebaKnot }             from './knots/Vainovska.js';
...
export function createKnotPoints(newMatType) {
    ...
    if (_matType == 'V4')        { nodepoints = Vainovska4Knot(); }
    if (_matType == 'V5')        { nodepoints = Vainovska5Knot(); }
    if (_matType == 'VS')        { nodepoints = SamebaKnot();     }
